...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_did(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(24_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(3_016_274 as u64).saturating_mul(m as u64))
	...
	fn remove_did(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(25_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(2_635_180 as u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(m as u64)))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(m as u64)))
	...
	fn add_did_services(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(14_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(3_178_878 as u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(m as u64)))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(m as u64)))
	...
	fn remove_did_services(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(14_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(2_970_083 as u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(m as u64)))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(m as u64)))
	...
	fn issue_credentials(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(20_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(3_864_228 as u64).saturating_mul(c as u64))
	...
	fn revoke_credentials(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(15_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(4_843_167 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(c as u64)))
	}
	...
	fn add_credentials_type(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(12_000_000 as u64)
			// Standard Error: 999
			.saturating_add(Weight::from_ref_time(401_761 as u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: DID CredentialsTypes (r:1 w:1)
	...
	fn remove_credentials_type(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(12_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(387_555 as u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
