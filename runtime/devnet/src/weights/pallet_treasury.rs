...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for WeightInfo<T> {
	fn spend() -> Weight {
		Weight::from_ref_time(436_000 as u64)
	}
	// Storage: Treasury ProposalCount (r:1 w:1)
	// Storage: Treasury Proposals (r:0 w:1)
	fn propose_spend() -> Weight {
		Weight::from_ref_time(62_715_000 as u64)
	...
	fn reject_proposal() -> Weight {
		Weight::from_ref_time(89_520_000 as u64)
	...
	fn approve_proposal(p: u32, ) -> Weight {
		Weight::from_ref_time(24_430_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(382_899 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Treasury Approvals (r:1 w:1)
	fn remove_approval() -> Weight {
		Weight::from_ref_time(20_368_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Treasury Approvals (r:1 w:1)
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		Weight::from_ref_time(81_279_000 as u64)
			// Standard Error: 405_673
			.saturating_add(Weight::from_ref_time(67_448_757 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
