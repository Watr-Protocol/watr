...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for WeightInfo<T> {
	...
	fn approve_proposal(p: u32, ) -> Weight {
		Weight::from_ref_time(30_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(35_353 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		Weight::from_ref_time(80_000_000 as u64)
			// Standard Error: 467_814
			.saturating_add(Weight::from_ref_time(62_620_000 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
