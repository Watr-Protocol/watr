...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(34_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(10_316_500 as u64).saturating_mul(c as u64))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(28_000_000 as u64)
			// Standard Error: 79_470
			.saturating_add(Weight::from_ref_time(10_635_500 as u64).saturating_mul(c as u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(29_000_000 as u64)
			// Standard Error: 114_115
			.saturating_add(Weight::from_ref_time(9_978_500 as u64).saturating_mul(c as u64))
	}
}
