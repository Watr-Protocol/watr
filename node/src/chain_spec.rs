...
pub const DOT_PARA_ID: u32 = 2058;
...
pub fn template_session_keys(keys: AuraId) -> watr_runtime::SessionKeys {
	watr_runtime::SessionKeys { aura: keys }
}
...
fn testnet_genesis(
	...
	watr_runtime::GenesisConfig {
		...
		session: watr_runtime::SessionConfig {
			keys: invulnerables
				.into_iter()
				.map(|(acc, aura)| {
					(
